...
function parseArgs(argv) {
  const opts = {
    ...
    reportPath: "reportlets/demo/市场监督/客座率监控/未来航班客座率票价分析-PG库.cpt",
    outputFile: process.env.FR_MIRROR_ROOT ? `${process.env.FR_MIRROR_ROOT}/指定航线/未来航班客座率票价分析.xlsx` : "./fr_mirror/指定航线/未来航班客座率票价分析.xlsx",
