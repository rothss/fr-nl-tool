...
REPORT_FAMILY_TO_NAME = {
    ...
    "adjusted_profit_overview": "航空集团收入利润概览（调整后）",
    "airline_yoy": "航空集团经营提升分析",
    "ranked_flights": "航空集团前十后十航班",
...
ANALYSIS_BINDINGS = {
    ...
    ("航空集团经营提升分析", ""): (analyze_airline_yoy, render_airline_yoy_answer),
    ("航空集团收入利润概览（调整后）", ""): (
        analyze_airline_yoy,
        render_airline_yoy_answer,
    ),
    ("航空集团前十后十航班", "first_flight_bottom10"): (
        analyze_first_flight_bottom10,
        render_first_flight_bottom10_answer,
    ),
    ("航空集团前十后十航班", "top_metric_flight"): (
        analyze_top_metric_flight,
        render_top_metric_flight_answer,
    ),
